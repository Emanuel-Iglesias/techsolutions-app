      ...
      <div className="max-w-6xl mx-auto mt-8 px-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button onClick={() => navigate('/history?entity=tasks')} className="bg-gray-500 text-white px-3 py-2 rounded-lg hover:bg-gray-600 transition font-semibold text-sm">📋 Historial</button>
            <button onClick={() => navigate('/tasks/new')} className="bg-blue-600 text-white px-3 py-2 rounded-lg hover:bg-blue-700 transition font-semibold text-sm">+ Nueva Tarea</button>
          </div>
        </div>
